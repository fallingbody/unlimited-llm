...
ENTRYPOINT ["/llama-server", "--host", "0.0.0.0", "--port", "7860", "--hf-repo", "Qwen/Qwen2.5-Coder-14B-Instruct-GGUF", "--hf-file", "qwen2.5-coder-14b-instruct-q4_k_m.gguf", "--ctx-size", "8192", "--threads", "2"]
